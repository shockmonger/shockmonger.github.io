...
<head>
	...
	<meta name="description" content="ScratchPad for FourMS">
<!-- 	<meta name="author" content="Paulo Nunes - syndicatefx.com">
		...
		<div id="setMenu" class="settings-menu">
			<ul>
				...
				<li class="settings-menu__item">
					...
					<input type="range" min="1" max="16" value="16" id="lw" step="1" title="Line Width">
				</li>
...
<button id = "button" value="Submit"></button>
